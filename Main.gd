...
const PATTERNS = [
	{
		...
		"actions": [
			[2.563636, Vector2(290, 510-60)],
			[3.109091, Vector2(430, 510-60)],
			[3.751515, Vector2(582, 510-60)],
			[4.4330303, Vector2(731, 510-60)],
			[5.036553, Vector2(841, 510-60)],
			[7.0, null]
		]
	},
	{
		...
		"actions": [
			[1.133333, Vector2(1007, 510-60)],
			[1.842424, Vector2(879, 510-60)],
			[2.460212, Vector2(792, 510-60)],
			[3.054151, Vector2(666, 510-60)],
			[3.611727, Vector2(542, 510-60)],
			[4.187485, Vector2(423, 510-60)],
			[5.5, null]
		]
	},
	{
		"name": "inside (easy)",
		"actions": [
			[0.575758, Vector2(269, 510-60)],
			[0.575758, Vector2(996, 510-60)],
			[1.145042, Vector2(436, 510-60)],
			[1.145042, Vector2(775, 510-60)],
			[2.0, null]
		]
	},
	{
		"name": "outside (easy)",
		"actions": [
			[0.980682, Vector2(551, 510-60)],
			[0.990682, Vector2(688, 510-60)],
			[2.206731, Vector2(390, 510-60)],
			[2.206731, Vector2(810, 510-60)],
			[3.0, null]
		]
	},
	{
		...
		"actions": [
			[1.5, Vector2(290, 510-60)],
			[1.75, Vector2(430, 510-60)],
			[2.0, Vector2(582, 510-60)],
			[2.25, Vector2(761, 510-60)],
			[2.5, Vector2(841, 510-60)],
			[4.0, null]
		]
	},
	{
		...
		"actions": [
			[0.791263, Vector2(986, 510-60)],
			[1.203886, Vector2(585, 510-60)],
			[1.658386, Vector2(232, 510-60)],
			[2.006766, Vector2(410, 510-60)],
			[2.324906, Vector2(770, 510-60)],
			[4.0, null]
		]
	},
	{
		"name": "trick two (hard)",
		"actions": [
			[1.630303, Vector2(822, 510-60)],
			[2.375758, Vector2(627, 510-60)],
			[2.709091, Vector2(456, 510-60)],
			[3.012121, Vector2(309, 510-60)],
			[4.0, null]
		]
	},
	{
		...
		"actions": [
			[1.545455, Vector2(890, 446-60)],
			[2.387879, Vector2(678, 597-60)],
			[3.447899, Vector2(476, 432-60)],
			[4.278202, Vector2(235, 598-60)],
			[5.0, null]
		]
	},
	{
		...
		"actions": [
			[1.812121, Vector2(1032, 450-60)],
			[2.206061, Vector2(874, 450-60)],
			[2.739394, Vector2(709, 450-60)],
			[3.157576, Vector2(574, 450-60)],
			[3.569697, Vector2(423, 450-60)],
			[4.059155, Vector2(272, 450-60)],

			[3.812121, Vector2(1032, 560-60)],
			[4.206061, Vector2(874, 560-60)],
			[4.739394, Vector2(709, 560-60)],
			[5.157576, Vector2(574, 560-60)],
			[5.569697, Vector2(423, 560-60)],
			[6.059155, Vector2(272, 560-60)],
	...
	},
	{
		...
		"actions": [
			[0.25, Vector2(250, 510-60)],
			[0.5, Vector2(350, 510-60)],
			[0.75, Vector2(450, 510-60)],
			[1, Vector2(600, 450-60)],
			[1.25, Vector2(750, 510-60)],
			[1.50, Vector2(850, 510-60)],
			[1.75, Vector2(950, 510-60)],
			[5.0, null]
		]
	},
]
